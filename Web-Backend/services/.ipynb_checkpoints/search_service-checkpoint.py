...
def search_text(query_content, score_threshold, app_config, top_k_first=10, ngram_n=3):
...
def search_picture(image_path, top_k, app_config):
    """使用Milvus进行图像pHash搜索"""
...
def search_video(video_path, top_k, app_config):
    ...
    try:
        ...
        search_conf.threshold = 0
        search_conf.top_k = top_k
